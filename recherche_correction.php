...
<body>
	...
	<form action="recherche.php" class = "liste" method="post">
		<!-- Ici va s'afficher le terme saisi dans le champ recherche
				s'il n'est pas nul -->
...
<!-- Ici va s'afficher la liste des resultats pour le mot cle "html"
	A adapter selon vos propres affichages de resultats -->

<!--  tableau de reponses � mettre en forme 	-->
...
<?php else: ?>
<!-- Ici va s'afficher la liste des resultats pour les autres recherches
